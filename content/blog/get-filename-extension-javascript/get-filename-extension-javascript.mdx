...
author: "Jordan"
featuredImage: file-extension-images.jpg
tags: ["JavaScript"]
---
...
The extension of the *index.html* filename begins with the dot character so in this case the extension would be **.html**.
